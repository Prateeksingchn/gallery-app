...
const Floating = () => {
  ...
  const floatingImages = [
    ...
    { src: "https://i.pinimg.com/236x/0e/42/7f/0e427fefb82a8f6326dbcce6e4468a56.jpg", alt: "Placeholder", className: "top-[7%] right-[7%] md:top-[10%] md:right-[8%] lg:top-[7%] lg:right-[10%] w-[55px] h-[60px] lg:w-[100px] lg:h-[100px] md:w-[110px] md:h-[110px] sm:top-[8%] sm:right-[2%] sm:w-[90px] sm:h-[90px]" },
    ...
    { src: "https://i.pinimg.com/236x/4a/cf/77/4acf771a623bb6acacf51b832374028f.jpg", alt: "Placeholder", className: "top-[15%] right-[32%] lg:top-[14%] lg:right-[23.7%] md:top-[23%] md:right-[27%] w-[50px] h-[60px]  lg:w-[160px] lg:h-[150px] md:w-[130px] md:h-[110px] sm:top-[17%] sm:right-[27%] sm:w-[130px] sm:h-[110px]" },
    ...
    { src: "https://i.pinimg.com/236x/c9/dd/59/c9dd590d03ea0cc26c8bdb94c53d92cb.jpg", alt: "Placeholder", className: "bottom-[2%] left-[14%] lg:bottom-[5%] lg:left-[25%] md:bottom-[9%] md:left-[20%] w-[60px] h-[40px] md:w-[110px] md:h-[90px] lg:w-[125px] lg:h-[140px] sm:bottom-[10%] sm:left-[16%] sm:w-[110px] sm:h-[90px]" },
