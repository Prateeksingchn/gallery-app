...
const Floating = () => {
  ...
  const floatingImages = [
    { src: "https://i.pinimg.com/236x/3d/18/21/3d182196300ee640b486dc88b3f09bb7.jpg", alt: "Placeholder", className: "top-[7%] left-[2%] lg:top-[5%] lg:left-[5%] md:top-[14.5%] md:left-[2%] w-[60px] h-[60px] lg:w-[130px] lg:h-[150px] md:w-[110px] md:h-[120px]" },
    { src: "https://i.pinimg.com/236x/0e/42/7f/0e427fefb82a8f6326dbcce6e4468a56.jpg", alt: "Placeholder", className: "top-[7%] right-[10%] md:top-[10%] md:right-[8%] lg:top-[7%] lg:right-[10%] w-[55px] h-[60px] lg:w-[100px] lg:h-[100px] md:w-[110px] md:h-[110px]" },
    ...
    { src: "https://i.pinimg.com/236x/98/8b/0d/988b0d2faafc1156acd8ea0b28009985.jpg", alt: "Placeholder", className: "bottom-[25%] right-[10%] md:bottom-[20%] md:right-[6%] lg:bottom-[20%] lg:right-[13%] w-[60px] h-[50px] lg:w-[140px] lg:h-[130px] md:w-[140px] md:h-[110px]" },
    { src: "https://i.pinimg.com/236x/a4/e2/02/a4e202ba80d3a9a0b8db24d75c73ff40.jpg", alt: "Placeholder", className: "top-[25%] left-[24%] lg:top-[22%] lg:left-[23%] md:top-[30%] md:left-[25%] w-[60px] h-[60px] md:w-[110px] md:h-[110px] lg:w-[120px] lg:h-[130px]" },
    { src: "https://i.pinimg.com/236x/4a/cf/77/4acf771a623bb6acacf51b832374028f.jpg", alt: "Placeholder", className: "top-[15%] right-[35%] lg:top-[14%] lg:right-[23.7%] md:top-[23%] md:right-[27%] w-[50px] h-[60px]  lg:w-[160px] lg:h-[150px] md:w-[130px] md:h-[110px]" },
    ...
    { src: "https://i.pinimg.com/236x/10/f3/c0/10f3c0375d6afc939af6f854b333bba1.jpg", alt: "Placeholder", className: "top-[41%] right-[3%] md:top-[39%] md:right-[4%] lg:top-[41%] lg:right-[3%] w-[55px] h-[60px] lg:w-[120px] lg:h-[120px] md:w-[110px] md:h-[140px] block md:block lg:block" },
    { src: "https://i.pinimg.com/236x/c9/dd/59/c9dd590d03ea0cc26c8bdb94c53d92cb.jpg", alt: "Placeholder", className: "bottom-[8%] left-[16%] lg:bottom-[5%] lg:left-[25%] md:bottom-[9%] md:left-[20%] w-[60px] h-[40px] md:w-[110px] md:h-[90px] lg:w-[125px] lg:h-[140px]" },
    ...
    { src: "https://i.pinimg.com/236x/3d/63/90/3d639037ba61d2f2548226940b360db5.jpg", alt: "Placeholder", className: "top-[45%] left-[50%] lg:top-[11%] lg:left-[42%] md:top-[6%] md:left-[37%] w-[40px] h-[40px] lg:w-[120px] lg:h-[110px] md:w-[100px] md:h-[110px] hidden md:block lg:block" },
  ];
