...
const Floating = () => {
  ...
  const floatingImages = [
    { src: "https://i.pinimg.com/236x/3d/18/21/3d182196300ee640b486dc88b3f09bb7.jpg", alt: "Placeholder", className: "top-[5%] left-[5%] lg: w-[80px] lg:h-[100px] w-[80px] h-[100px] md:w-[130px] md:h-[150px]" },
    { src: "https://i.pinimg.com/236x/0e/42/7f/0e427fefb82a8f6326dbcce6e4468a56.jpg", alt: "Placeholder", className: "top-[7%] right-[10%] w-[70px] h-[70px] lg:w-[70px] lg:h-[70px] md:w-[110px] md:h-[110px]" },
    ...
    { src: "https://i.pinimg.com/236x/a4/e2/02/a4e202ba80d3a9a0b8db24d75c73ff40.jpg", alt: "Placeholder", className: "lg:top-[22%] lg:left-[23%] top-[27%] left-[17%] md:top-[27%] md:left-[25%] w-[80px] h-[80px] md:w-[130px] md:h-[130px]" },
    { src: "https://i.pinimg.com/236x/4a/cf/77/4acf771a623bb6acacf51b832374028f.jpg", alt: "Placeholder", className: "lg:top-[14%] lg:right-[23.7%] top-[17%] right-[25%] md:top-[17%] md:right-[30%] w-[100px] h-[120px] lg:w-[100px] lg:h-[120px] md:w-[150px] md:h-[150px] " },
    ...
    { src: "https://i.pinimg.com/236x/10/f3/c0/10f3c0375d6afc939af6f854b333bba1.jpg", alt: "Placeholder", className: "top-[40%] right-[5%] w-[70px] h-[90px] lg:w-[70px] lg:h-[90px] md:w-[110px] md:h-[140px] hidden md:block lg:block" },
    ...
    { src: "https://i.pinimg.com/236x/3d/63/90/3d639037ba61d2f2548226940b360db5.jpg", alt: "Placeholder", className: "lg:top-[15%] lg:left-[45%] top-[35%] left-[45%] lg: w-[80px] lg:h-[100px] w-[80px] h-[100px] md:w-[120px] md:h-[150px] hidden md:hidden lg:block" },
  ];
