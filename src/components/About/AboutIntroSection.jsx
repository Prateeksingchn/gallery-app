...
const AboutIntroSection = ({ backgroundImageUrl, scrollToAbout }) => {
  return (
    <div
      className="h-[550px] md:h-[850px] lg:h-screen bg-cover bg-center flex flex-col justify-center items-start px-4 md:px-7 lg:px-16 pt-32 md:pt-[200px] lg:pt-0"
    ...
    >
      ...
      >
        <h1 className="text-5xl md:text-8xl lg:text-8xl mb-4 font-bold text-zinc-700 font-[Kalnia]">
          PixelPerfect
        </h1>
        <h2 className="text-3xl md:text-6xl lg:text-6xl mb-8 text-zinc-700 opacity-90 font-[pacifico]">
          Gallery
        </h2>
